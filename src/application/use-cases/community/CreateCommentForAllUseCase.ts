...
export class CreateCommentForAllUseCase {
  constructor(
    private postRepository: IPostRepository,
    private userRepository: IUserRepository, // Changed from IPostRepository
  ...
  async execute(dto: CreateCommentDTO): Promise<Comment> {
    ...
    const commentableItem = await this.postRepository.findPostAndAnnouncementById(dto.postId);
    if (!commentableItem) {
